...
class Order(models.Model):
    ...
    def _generate_order_number():
        """Generates order numbers like ORD-2026-0001, sequential per year."""
...
class OrderItem(models.Model):
    ...
    food_name = models.CharField(max_length=150)  # snapshot in case item is later deleted/renamed
